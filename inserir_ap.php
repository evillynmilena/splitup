						...
						if (!(
							...
							if ($vinculo == 0) {
								...
								if (!$insert){
									...
									$id_ap = pg_result($resultset2, 0, 0);

									/*mudando usuario para admin*/
									$cadeia5 = "UPDATE morador SET admin = TRUE, id_imovel = $id_ap WHERE id_morador = $id_mor;";
									$cadeia6 = "UPDATE imovel SET id_mor_admin = $id_mor WHERE id_imovel = $id_ap; ";
									$cadeia7 = "INSERT INTO apartamento VALUES($id_ap,'$form_nome'); ";
