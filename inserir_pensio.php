				...
				<article class='two_quarter'>
					<?php
						...
						if (isset($_POST['salvar'])) {
							$form_restricao = $_POST['restricao'];
						...
						if (!(
							...
							if ($vinculo == 0) {
								...
								if (!$insert){
									...
									$id_pensio = pg_result($resultset2, 0, 0);

									/*mudando usuario para admin*/
									$cadeia5 = "UPDATE morador SET admin = TRUE, id_imovel = $id_pensio WHERE id_morador = $id_mor;";
									$cadeia6 = "UPDATE imovel SET id_mor_admin = $id_mor WHERE id_imovel = $id_pensio; ";
									$cadeia7 = "INSERT INTO pensionato VALUES($id_pensio,'$form_restricao'); ";
