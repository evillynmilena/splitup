    ...
    <div id='banner'>
      <section class='clear'>
        ...
        <article class='center_wide'>
          ...
          $cadeia = "SELECT * FROM Imovel AS I, Republica AS R, Facul_rep AS F
          WHERE I.id_imovel = R.id_imovel AND I.id_imovel = F.id_imovel;";
          $resultset = consulta($conexao, $cadeia);
          $nlinhas = pg_num_rows($resultset);

          for ($i=0; $i<$nlinhas; $i++){
            // recupera campos do resultado
            $nome = pg_result($resultset, $i, 16);
            $faculdade = pg_result($resultset, $i, 18);
              ...
              "<table border='0'>".
                "<tr>".
                  "<td class='one dark'>".
                    "<b>Nome:</b>".
                  "</td>".
                  "<td class='four light' colspan='4'>".
                    "<div class='upperinline'>".$nome."</div>".
                  "</td>".
                  "<td class='one dark'>".
                    "<b>Faculdade:</b>".
                  "</td>".
                  "<td class='light' colspan='3'>".
                    "<div class='upperinline'>".$faculdade."</div>".
                  "</td>".
                "</tr>".
                "<tr>".
                  "<td class='dark'>".
